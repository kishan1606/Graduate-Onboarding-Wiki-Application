...
public class Seeder implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
	  ...
	  creds10.setUsername("helena");
	  creds10.setPassword("asd3");
	  ...
	  creds11.setUsername("kenny");
	  creds11.setPassword("asd2");
	  ...
	  creds12.setUsername("will");
	  creds12.setPassword("asd1");
